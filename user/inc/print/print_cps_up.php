            ...
            ?>
                <div class="mt-5 d-flex flex-column flex-column-reverse flex-lg-row justify-content-between ">
                    <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 offset-xl-1">
                        <h4 class="modal-title fw-bold text-nowrap mt-3 mt-md-0">BSP CLOUDPAK SYSTEM FORM (UPDATE)</h4>
                    </div>
                    ...
                    <div class="row d-flex justify-content-center g-0 mb-2">
                            ...
                            <div class="table-responsive mb-2">
                                <table class="table table-borderless text-nowrap align-middle text-dark table-sm">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td colspan="2">
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_system_name" id="cps_up_system_name" value="<?php echo empty($system_name) ? '' : $system_name; ?>" readonly />
                                            </td>
                                            
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_instance_name" id="cps_up_instance_name" value="<?php echo empty($instance_name) ? '' : $instance_name; ?>" readonly />
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-select form-select-sm text-dark" name="cps_up_location" id="cps_up_location" required>
                                            ...
                                            <td>
                                                <select class="form-select form-select-sm text-dark" name="cps_up_env_profile" id="cps_up_env_profile" required>
                                            ...
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_pattern" id="cps_up_pattern" value="<?php echo empty($pattern) ? '' : $pattern; ?>" readonly />
                                            </td>  
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless table-sm align-middle text-nowrap text-dark " id="cps_tab_logic_up">
                                    <thead class="bg-dark text-white">
                                        <tr >
                                            ...
                                            <td colspan="2">
                                                <?php if (empty($control_number)): ?>
                                                    <div class="input-group">
                                                        <input class="form-control form-control-sm text-dark shadow-none" type="search" name="cps_up_search_txt" id="cps_up_search_txt" value="<?php echo empty($hostname) ? '' : $hostname; ?>" >
                                                ...
                                                <?php endif; ?>
                                                <?php if (!empty($control_number)): ?>
                                                        <input class="form-control form-control-sm text-dark shadow-none" type="text" name="cps_up_search_txt" id="cps_up_search_txt" readonly value="<?php echo empty($hostname) ? '' : $hostname; ?>" >
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="4">
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ip_add" id="cps_up_ip_add" value="<?php echo empty($ip_add) ? '' : $ip_add; ?>"  readonly/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">IP Group</td>
                                            <td colspan="4">
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ip_group" id="cps_up_ip_group" value="<?php echo empty($ip_group) ? '' : $ip_group; ?>" readonly />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">vCPU</td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_vcpu_size" id="cps_up_vcpu_size" value="<?php echo empty($vcpu_size_old) ? '' : $vcpu_size_old; ?>" readonly /> 
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_vcpu_size_req" id="cps_up_vcpu_size_req" value="<?php echo empty($vcpu_size) ? '' : $vcpu_size; ?>"  />
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_vcpu_filesystem" id="cps_up_vcpu_filesystem" value="<?php echo empty($vcpu_filesystem) ? '' : $vcpu_filesystem; ?>" />
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_vcpu_remarks" id="cps_up_vcpu_remarks"  value="<?php echo empty($vcpu_remarks) ? '' : $vcpu_remarks; ?>" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">RAM (GB)</td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ram_size" id="cps_up_ram_size" value="<?php echo empty($ram_size_old) ? '' : $ram_size_old; ?>"  readonly /> 
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ram_size_req" id="cps_up_ram_size_req" value="<?php echo empty($ram_size) ? '' : $ram_size; ?>"  />
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text"  name="cps_up_ram_filesystem" id="cps_up_ram_filesystem" value="<?php echo empty($ram_filesystem) ? '' : $ram_filesystem; ?>"  />
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ram_remarks" id="cps_up_ram_remarks"  value="<?php echo empty($ram_remarks) ? '' : $ram_remarks; ?>" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">User Registration</td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ue_enroll_size" id="cps_up_ue_enroll_size" value="<?php echo empty($ue_enroll_size_old) ? '' : $ue_enroll_size_old; ?>"  readonly /> 
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ue_enroll_size_req" id="cps_up_ue_enroll_size_req" value="<?php echo empty($ue_enroll_size) ? '' : $ue_enroll_size; ?>"  />
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ue_filesystem" id="cps_up_ue_filesystem" value="<?php echo empty($ue_filesystem) ? '' : $ue_filesystem; ?>" />
                                            </td>
                                            <td>
                                                <input class="form-control form-control-sm text-dark" type="text" name="cps_up_ue_remarks" id="cps_up_ue_remarks" value="<?php echo empty($ue_remarks) ? '' : $ue_remarks; ?>" />
                                            </td>
                                        </tr>
                                            ...
                                            if (!empty($control_number)):
                                                ...
                                                if ($count_2 > 0) {
                                                    while ($rows_2 = mysqli_fetch_assoc($sql_2)) {
                                                        ...
                                                        echo '<td><input type="hidden" name="others_id[]" value="'.$rows_2['others_id'].'"><input class="form-control form-control-sm text-dark" type="text" name="others_1[]" value="'.$rows_2['others_1'].'" readonly></td>';
                                                        echo '<td><input class="form-control form-control-sm text-dark" type="text" name="others_2[]" value="'.$rows_2['others_2'].'" ></td>';
                                                        echo '<td><input class="form-control form-control-sm text-dark" type="text" name="others_3[]" value="'.$rows_2['others_3'].'" ></td>';
                                                        echo '<td><input class="form-control form-control-sm text-dark" type="text" name="others_4[]" value="'.$rows_2['others_4'].'" ></td>';
                                                        echo '</tr>';
                                                    }
                                                }else{
                                                    echo '<tr>';
                                                    echo '<td class="text-dark fw-bold">Disk (GB)</td>';
                                                    echo '<td><input type="hidden" name="others_id[]" ><input class="form-control form-control-sm text-dark" type="text" name="others_1[]"  readonly></td>';
                                                    echo '<td><input class="form-control form-control-sm text-dark" type="text" name="others_2[]" ></td>';
                                                    echo '<td><input class="form-control form-control-sm text-dark" type="text" name="others_3[]"></td>';
                                                    echo '<td><input class="form-control form-control-sm text-dark" type="text" name="others_4[]"></td>';
                                                    echo '</tr>';     
                                                }
                                            endif;
                                            if (empty($control_number)):
