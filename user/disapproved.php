...
$disapproved_count_hci = mysqli_num_rows($sql_hci); // Count the number of Disapproved Form HCI

$sql_cps = mysqli_query($conn,$query_cps);
$disapproved_count_cps = mysqli_num_rows($sql_cps); // Count the number of Disapproved Form HCI
...
<html>
    <head>
        ...
        <title>Alapaap | Disapproved Request</title>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex justify-content-between align-items-center mb-4">
                            <h3 class="text-dark mb-0 mb-3 mb-sm-0">Disapproved Form</h3>
                        </div>
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active position-relative" role="tab" data-bs-toggle="tab" href="#tab-1">HCI                 
                                                <?php 
                                                    if (($my_role == 1 ||  $my_role == 2 || $my_role == 3 || $my_role == 4 || $my_role == 5 || $my_role == 6) && $disapproved_count_hci >= 1){ // if na meet yung condition mag di-display yung badge na may total numbers of approved!
                                                        echo '<span class="position-absolute top-0 start-100 translate-middle badge badge-small rounded-pill bg-danger" >'.$disapproved_count_hci.'+</span>';
                                                    } 
                                                ?>                                        
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link position-relative" role="tab" data-bs-toggle="tab" href="#tab-3">CPS
                                                <?php 
                                                    if (($my_role == 1 ||  $my_role == 2 || $my_role == 3 || $my_role == 4 || $my_role == 5 || $my_role == 6) && $disapproved_count_cps >= 1){ // if na meet yung condition mag di-display yung badge na may total numbers of approved!
                                                        echo '<span class="position-absolute top-0 start-100 translate-middle badge badge-small rounded-pill bg-danger" >'.$disapproved_count_cps.'+</span>';
                                                    } 
                                                ?>
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link position-relative" role="tab" data-bs-toggle="tab" href="#tab-4">BaaS                 
                                                <?php 
                                                    if (($my_role == 1 ||  $my_role == 2 || $my_role == 3 || $my_role == 4 || $my_role == 5 || $my_role == 6) && $disapproved_count_baas >= 1){ // if na meet yung condition mag di-display yung badge na may total numbers of approved!
                                                        echo '<span class="position-absolute top-0 start-100 translate-middle badge badge-small rounded-pill bg-danger" >'.$disapproved_count_baas.'+</span>';
                                                    } 
                                                ?>                                        
                                            </a>
                                        </li>
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($my_role == 1) {
                                                                ...
                                                                while ($rows_hci = mysqli_fetch_array($hci_query)):                        
                                                                   ...
                                                                   // For Requestor
                                                                    if ($my_role == 1 && $rows_hci['status'] == 0):
                                                                        $reject_by  = $rows_hci['approver'];
                                                                        $role_by    = 'BSP Approver';
                                                                    endif;

                                                                    if ($my_role == 2 && $rows_hci['app_status'] == 0):
                                                                        $reject_by  = $rows_hci['approver'];
                                                                        $role_by    = 'BSP Approver';
                                                                    endif;
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($my_role == 1) {
                                                                ...
                                                                while ($rows_cps = mysqli_fetch_array($cps_query)):                        
                                                                   ...
                                                                   // For Requestor
                                                                    if ($my_role == 1 && $rows_cps['status'] == 0):
                                                                        $reject_by  = $rows_cps['approver'];
                                                                        $role_by    = 'BSP Approver';
                                                                    endif;

                                                                    if ($my_role == 2 && $rows_cps['app_status'] == 0):
                                                                        $reject_by  = $rows_cps['approver'];
                                                                        $role_by    = 'BSP Approver';
                                                                    endif;
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($my_role == 1) {
                                                                ...
                                                                while ($rows_baas = mysqli_fetch_array($sql_baas)):                        
                                                                    ...
                                                                    if ($my_role == 1 && $rows_baas['status'] == 0):
                                                                        $reject_by  = $rows_baas['approver'];
                                                                        $role_by    = 'BSP Approver';
                                                                    endif;
                                                                    
                                                                    if ($my_role == 2 && $rows_baas['app_status'] == 0):
                                                                        $reject_by  = $rows_baas['approver'];
                                                                        $role_by    = 'BSP Approver';
                                                                    endif;
